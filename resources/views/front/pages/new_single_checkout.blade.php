            ...
            <div class="card-body p-4">
                ...
                <form action="" method="post" name="order_form" id="order_form">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label"><i class="bi bi-truck me-1 text-warning"></i> জেলা নির্বাচন
                                করুন</label>
                        ...
                        <!-- Shipping Method -->
                        <div class="col-12">
                            <label class="form-label"><i class="bi bi-truck me-1 text-warning"></i> শিপিং চার্জ</label>
                    ...
                    <div
                        ...
                        @if (!empty($selected_products))
                            @foreach ($selected_products as $item)
                                @php
                                    $NewProduct = NewProduct::where('id', $item->product_id)->first();
                                @endphp
                                <p style="margin:0 0 8px; font-weight:600; color:#444;">
                                    <i class="bi bi-basket-fill me-1"></i> {{ $NewProduct->name }} ({{ $item->sku }})
                                ...
                                <input type="hidden" name="product_title" value="{{ $NewProduct->name }}">
                        ...
                        <div style="display:flex; justify-content:space-between; margin-top:10px; font-size:15px;">
                            ...
                            <input type="text" id="subtotal" name="subtotal"
                                value="{{ $item->selling_price * $selected_qty }}" readonly
                        ...
                        <div style="display:flex; justify-content:space-between; margin-top:5px; font-size:15px;">
                            ...
                            <input type="text" id="shipping_charge2" name="shipping_charge2" value="0.00" readonly
                                style="width:100px; font-weight:bold; text-align:right; border:none; background:transparent;">
                        </div>
                        ...
                        <div
                            ...
                            <span>সর্বমোট</span>
                            <input type="text" id="grand_total" name="grand_total" value="{{ $item->price }}"
                                readonly
                                style="width:100px; font-weight:bold; text-align:right; border:none; background:transparent;">
                        </div>
                    </div>
...
@section('customJs')
    <script>
        $(document).ready(function() {
            let subtotal = parseFloat("{{ $item->selling_price * $selected_qty }}") || 0;
            let shipping = 0;
            let discount = 0;
            let appliedCoupon = "";
            ...
            function updateTotals() {
                ...
                $("#shipping_charge2").val(shipping.toFixed(2));
        ...
        $(document).ready(function() {
            ...
            $("#order_form").submit(function(event) {
                ...
                $.ajax({
                    url: '{{ route('front.singCheckout', $item->id) }}',
                    type: 'post',
