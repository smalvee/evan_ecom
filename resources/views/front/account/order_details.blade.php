...
@section('content')
    ...
    <section><br>
        <div class="container">
            <!-- Order Summary -->
            <div class="card mb-4">
                <div class="card-header" style="background:#FC8934;color:#fff;">
            ...
            <!-- Back Button -->
            <div class="mt-3">
                <a href="{{ route('account.userDashboard') }}" class="btn" style="background:#FC8934;color:#fff;">← Back to Dashboard</a>
            </div>
        </div>
    </section>
@endsection
