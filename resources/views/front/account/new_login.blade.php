            ...
            <div class="row">
                <div class="col-xxl-6 col-xl-5 col-lg-6 d-lg-block d-none ms-auto">
                    <div class="image-contain">
                        <img src="{{ asset('new-front-assets/images/inner-page/log-in.png') }}" class="img-fluid"
                            alt="">
                    </div>
                </div>
                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-sm-8 mx-auto">
                    <div class="log-in-box">.
                        ...
                        <div class="input-box">
                            <form class="row g-4" action="{{ route('account.authenticate') }}" method="post">
                                @csrf
                                <div class="col-12">
                                    <div class="form-floating theme-form-floating log-in-form">
                                        <input type="text" class="form-control @error('login') is-invalid @enderror"
                                            id="login" name="login" placeholder="Enter your email or phone"
                                            value="{{ old('login') }}">
                                        @error('login')
