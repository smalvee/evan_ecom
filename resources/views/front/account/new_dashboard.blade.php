                ...
                <div class="container" style="max-width:1100px;margin:auto;padding:0 20px;">
                    ...
                    <div class="card mb-4"
                        ...
                        <div class="card-header"
                            style="background:linear-gradient(90deg,#d99f46,#ff9f50);color:#fff;padding:15px 25px;text-align:center;">
                            <ul
                    ...
                    <div class="card mb-4"
                        style="border:none;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,0.08);overflow:hidden;">
                        <div class="card-header"
                            style="background:linear-gradient(90deg,#d99f46,#ff9f50);color:#fff;padding:15px 25px;">
                                                ...
                                                <tr style="border-bottom:1px solid #f0f0f0;">
                                                    ...
                                                    <td style="padding:10px;">
                                                        <a href="{{ route('account.orderDetails', $order->id) }}"
                                                            style="background:#d99f46;color:#fff;padding:6px 12px;border-radius:6px;text-decoration:none;font-size:13px;transition:0.3s;display:inline-block;">
                                                            View Details
                                                        </a>
                                                    </td>
                                                </tr>
