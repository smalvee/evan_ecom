...
@section('content')
    ...
    <section style="background:#FC8934;color:#fff;" class="py-3">
        <div class="container text-center">
            <h1 class="fw-bold mb-1">Track Order</h1>
            <p class="mb-0">Enter your order details below to check the status of your order</p>
        </div>
    </section>
    ...
    <section class="py-5">
        <div class="container">
            ...
            <div id="customer-info" class="mb-3 text-center" style="display:none;">
                <h6>Customer Info</h6>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status === 'success') {
                        ...
                        // Always active: OrderPlaced
                        $(".track .step[data-status='OrderPlaced']").addClass("active");

                        if (status === 'confirm' || status === 'shipped' || status === 'shipped') {
