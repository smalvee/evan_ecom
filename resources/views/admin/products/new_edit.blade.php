...
@section('content')
    ...
    @php
        $defaultVariant = $product_variation->firstWhere('is_variant', 0) ?? $product_variation->first();
        $categoryName = $categories->firstWhere('id', $product->cat_id)?->name ?? '—';
    @endphp
    ...
    <div class="container-fluid">
        <div class="a-page-head">
            <div class="a-page-head-text">
                ...
                <p class="a-page-desc">Update product information, variations and selling options.</p>
            </div>
            <div class="a-actions">
                ...
                <div class="pf-stack">
                        ...
                        <div class="a-card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="sub_category" id="sub_category" class="form-control js-select2">
                    ...
                    <div class="a-card">
                        <div class="a-card-body">
                            ...
                            <textarea name="description" id="description" rows="8" class="summernote" placeholder="Description">{!! $product->description !!}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="a-card">
                        <div class="a-card-body">
                            ...
                            <div class="pf-types">
                                <div>
                                    <input type="radio" class="pf-type-input" name="product_type" id="type_single"
                                        value="0" {{ (int) $product->type === 0 ? 'checked' : '' }}>
                                ...
                                <div>
                                    <input type="radio" class="pf-type-input" name="product_type" id="type_variable"
                                        value="1" {{ (int) $product->type === 1 ? 'checked' : '' }}>
                            ...
                            <div class="alert alert-warning py-2 px-3 small mt-3 mb-0" id="typeChangeWarning" hidden>
                                <i class="ri-alert-line"></i> Changing the product type can affect existing variants. Review
                                the generated variants before saving.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="a-card mb-3">
                        <div class="a-card-body">
                            ...
                            <ul class="list-unstyled mb-0 small">
                                <li class="d-flex justify-content-between py-1 gap-2"><span
                                        class="text-muted">Name</span><strong class="text-end">{{ $product->name }}</strong>
                                </li>
                                <li class="d-flex justify-content-between py-1 gap-2"><span
                                        class="text-muted">SKU</span><strong>{{ $product->sku }}</strong></li>
                                <li class="d-flex justify-content-between py-1 gap-2"><span
                                        class="text-muted">Type</span><strong>{{ (int) $product->type === 1 ? 'Variable' : 'Single' }}</strong>
                                </li>
                                <li class="d-flex justify-content-between py-1 gap-2"><span
                                        class="text-muted">Category</span><strong class="text-end">{{ $categoryName }}</strong>
                                </li>
                                <li class="d-flex justify-content-between py-1 gap-2"><span
                                        class="text-muted">Variants</span><strong><span
                                            id="summaryVariantCount">0</span></strong></li>
                                <li class="d-flex justify-content-between py-1 gap-2"><span
                        ...
                        <div class="a-card-body">
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="free_delivery"
                                        id="free_delivery" value="1" {{ $product->free_delivery ? 'checked' : '' }}>
                            ...
                            <div class="mb-3" id="singlePreorderWrap">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="allow_pre_order"
                                        ...
                                        {{ !empty($defaultVariant->allow_pre_order) ? 'checked' : '' }}>
                            ...
                            <div class="mb-0">
                                ...
                                <select name="hot_products" id="hot_products" class="form-control">
                                    <option value="0" {{ (int) $product->hot_products === 0 ? 'selected' : '' }}>Inactive
                                    </option>
                                    <option value="1" {{ (int) $product->hot_products === 1 ? 'selected' : '' }}>Active
                                    </option>
                                </select>
                            </div>
                        </div>
...
@section('customJs')
    <script>
        window.PRODUCT_FORM_CONFIG = {
            ...
            initialType: '{{ (int) $product->type }}',
            variations: @json($variationData),
            existingVariants: @json($variantsForJs),
            urls: {
                store: '',
                update: '{{ route('update_product.update', $product->id) }}',
